...
class AI_Site_Builder_Library_WXR_Importer {
	...
	private function __construct() {
		...
		if ( ! class_exists( 'WP_Importer_Logger' ) ) {
			require_once AI_SITE_BUILDER_DIR_PATH . 'core/importer/class-logger.php';
		}

		if ( ! class_exists( 'WP_Importer_Logger_ServerSentEvents' ) ) {
			require_once AI_SITE_BUILDER_DIR_PATH . 'core/importer/class-wp-importer-logger-serversentevents.php';
		}

			//$this->elementor_competibilty();
		if ( ! class_exists( 'WXR_Importer' ) ) {
			require_once AI_SITE_BUILDER_DIR_PATH . 'core/importer/class-wxr-importer.php';
		}

		if ( ! class_exists( 'WXR_Import_Info' ) ) {
			require_once AI_SITE_BUILDER_DIR_PATH . 'core/importer/class-wxr-import-info.php';
		}
